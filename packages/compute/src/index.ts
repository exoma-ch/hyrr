...
// --- Canonical config-codec types (generated from Rust, #539) ---
// The one Rust-owned config type + its size/outcome policy, generated by ts-rs
// from `hyrr-core::config_codec` (CI drift-gated). The browser codec bridge
// (`frontend/src/lib/config-codec.ts`) marshals these across the WASM boundary.
export type {
  CodecConfig,
  Beam as CodecBeam,
  Layer as CodecLayer,
  Group as CodecGroup,
  Item as CodecItem,
  CustomMaterial as CodecCustomMaterial,
  CurrentProfile as CodecCurrentProfile,
  SizePolicy as CodecSizePolicy,
  EncodeOutcome as CodecEncodeOutcome,
  JsonValue as CodecJsonValue,
} from "./generated/config-codec";
